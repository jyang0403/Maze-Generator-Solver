 ...
 *
 * \details This function takes four parameters: the name of the file to read, the maze itself, and the pointers to the maze's width and height. The function reads the file, filling in maze's data, width and height. It returns 0 on success, -1 if failed to open the file to read, or -2 if encountering any other read error.
 */
